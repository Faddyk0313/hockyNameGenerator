...
interface StateRow {
  ...
  label: string;
  policy: Policy;
  message: string;      // ← new “Messaging” column
}
...
export default function Home() {
  ...
  const handleRowChange = (
    ...
    const newRows = [...rows];
    newRows[index] = { ...newRows[index], [field]: value } as StateRow;
    setRows(newRows);
  };
  ...
  const addRow = () =>
    setRows([
      ...rows,
      { key: "", label: "", policy: "continue", message: "" },
    ]);
      ...
      <table className="w-full border-collapse mb-4">
        <thead>
          <tr>
            ...
            <th className="border p-2">ATC Label</th>
            <th className="border p-2">Policy</th>
            <th className="border p-2">Messaging</th> {/* new header */}
            ...
            <tr key={idx}>
              ...
              <td className="border p-2">
                <select
                  ...
                  value={row.policy}
                  onChange={(e) =>
                    handleRowChange(idx, "policy", e.target.value)
                  }
                >
              ...
              <td className="border p-2">
                <input
                  ...
                  value={row.message}
                  onChange={(e) =>
                    handleRowChange(idx, "message", e.target.value)
                  }
                />
              </td>
